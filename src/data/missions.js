(function initMissionCatalog(root, factory) {
    ...
    const vehicle = (name, type, massKg, facts, image, imageAlt) => ({ name, type, massKg, facts, image, imageAlt });
    ...
    const missions = [
        mission({
            ...
            result: 'Вывод искусственного спутника на орбиту подтверждён; прохождение радиосигнала через ионосферу исследовано.',
            story: [
            ...
            simulationStory: [
                'Первоначально первым советским спутником должен был стать тяжёлый научный аппарат с множеством приборов. Его подготовка затягивалась, и Сергей Королёв предложил не ждать: собрать максимально простой ПС-1 и успеть вывести его во время Международного геофизического года. Так инженерная гонка привела к устройству, в котором почти нечему было ломаться.',
                'Внутри алюминиевой сферы поддерживалась азотная атмосфера давлением около 1,3 атмосферы. Более половины массы аппарата приходилось на три серебряно-цинковые батареи. Два передатчика, система терморегулирования и датчики температуры и давления превратили короткие радиосигналы не только в позывной новой эпохи, но и в простую телеметрию состояния спутника.',
                'Знаменитое «бип-бип» звучало попеременно на частотах 20,005 и 40,002 мегагерца. Эти диапазоны могли принимать обычные радиолюбители, поэтому существование спутника невозможно было скрыть или представить пропагандистским заявлением. Любопытная деталь: невооружённым глазом наблюдатели чаще видели яркую центральную ступень ракеты Р-7, также вышедшую на орбиту, а не небольшую сферу ПС-1.',
                'Сам аппарат не нёс камер и сложной научной лаборатории, однако его радиосигнал помогал исследовать распространение волн через ионосферу, а изменение орбиты — оценивать плотность верхней атмосферы. Наземным службам пришлось быстро учиться вычислять орбиту и заранее предсказывать появление объекта над горизонтом: зарождалась практическая система слежения за космическими аппаратами.',
                'Батареи иссякли 26 октября, после чего спутник замолчал, но ещё больше двух месяцев оставался на орбите. 4 января 1958 года он вошёл в атмосферу и сгорел. Маленькая сфера просуществовала всего 92 дня, зато её запуск резко ускорил ракетные и спутниковые программы во всём мире и сделал выражение «космическая эра» буквальным.'
            ],
            ...
            ], 'spacecraft/sputnik-1.png', 'Реалистичная учебная иллюстрация сферического спутника ПС-1 с четырьмя антеннами'),
            trajectory: earthOrbitTrajectory('1957-10-04T19:28:34Z', '1958-01-04T00:00:00Z', {
                ...
                phaseDeg: -60, displayOrbits: 3, launchAngleDeg: -60, launchProgress: 0.08,
        ...
        mission({
            ...
            result: 'Подтверждено, что человек способен находиться в космосе и безопасно вернуться на Землю.',
            story: [
            ...
            simulationStory: [
                'Утро перед стартом едва не принесло задержку: после закрытия люка датчик показал неплотный контакт. Техникам пришлось снять десятки креплений, проверить уплотнение и снова закрыть корабль прямо на вершине ракеты. Пока специалисты работали, Гагарин попросил включить музыку. Примерно за полчаса до старта его пульс составлял спокойные 64 удара в минуту.',
                'Инженеры ещё не знали, сохранит ли человек способность рассуждать и управлять техникой в невесомости, поэтому полёт почти полностью доверили автоматике. Для ручного управления требовалось набрать код 125, лежавший в запечатанном конверте. Несколько специалистов на всякий случай сообщили код Гагарину заранее — космонавт знал способ перехватить управление ещё до старта.',
                'Через десять минут после взлёта «Восток» отделился от последней ступени. Из маленького иллюминатора и оптического устройства «Взор» Гагарин видел облака, горизонт и быстро сменивший день ночной участок орбиты. Связь с наземными станциями периодически исчезала: корабль уходил за радиогоризонт, и часть сообщений передавалась по менее надёжному коротковолновому каналу.',
                'Тормозной двигатель включился над западным побережьем Африки и проработал около 42 секунд. После импульса приборный отсек не отделился полностью: два модуля остались связаны кабелями и начали беспорядочно вращаться при входе в атмосферу. Провода перегорели от нагрева, сфера заняла устойчивое положение, а Гагарин выдержал перегрузку примерно в восемь единиц.',
                'На высоте около семи километров люк отделился, и Гагарин катапультировался, приземлившись отдельно от капсулы. Первыми его увидели местная женщина с девочкой: человек в ярком скафандре и с парашютом напугал их, и космонавту пришлось объяснить, что он советский и только что вернулся из космоса. От старта до посадки прошло всего 108 минут — один виток изменил историю.'
            ],
            ...
            ], 'spacecraft/vostok-3ka.png', 'Реалистичная учебная иллюстрация корабля Восток 3КА со сферической спускаемой капсулой'),
            trajectory: earthOrbitTrajectory('1961-04-12T06:07:00Z', '1961-04-12T08:05:00Z', {
                ...
                phaseDeg: -60, displayOrbits: 1, launchAngleDeg: -60, launchProgress: 0.085,
            ...
            sources: [
                source('nasa-vostok-1', 'Vostok 1', 'NASA', 'https://starchild.gsfc.nasa.gov/docs/StarChild/space_level2/vostok1.html'),
                source('esa-vostok-1-flight', 'The flight of Vostok 1', 'ESA', 'https://www.esa.int/About_Us/50_years_of_ESA/50_years_of_humans_in_space/The_flight_of_Vostok_1')
            ]
        }),
        mission({
            ...
            result: 'Получены данные о влиянии многосуточного полёта на организм; испытания корабля «Восток» продолжены.',
            story: [
            ...
            simulationStory: [
                'До отряда космонавтов Валентина Терешкова работала на текстильном комбинате и занималась парашютным спортом. Именно опыт самостоятельных прыжков был особенно важен: пилот «Востока» возвращался на Землю не внутри капсулы, а катапультировался и садился на личном парашюте. Для подготовки к полёту ей пришлось за короткое время освоить технику, медицину и сложные тренировки.',
                '«Восток-6» стартовал под позывным «Чайка», когда на орбите уже находился «Восток-5» Валерия Быковского. Это был согласованный групповой полёт, но не попытка стыковки: корабли не умели активно сближаться. На первом витке расстояние между ними сократилось примерно до пяти километров, после чего аппараты постепенно разошлись по своим орбитам.',
                'За 70 часов 50 минут Терешкова совершила 48 оборотов вокруг Земли — больше, чем суммарное орбитальное время всех американских астронавтов к тому моменту. Она поддерживала радиосвязь с Быковским и Землёй, вела журнал, контролировала системы и фотографировала горизонт. Снимки и медицинские наблюдения были частью исследования поведения организма в многосуточной невесомости.',
                'Трое суток в тесной сфере оказались тяжёлой работой: ограниченное пространство, скафандр, шум оборудования, нарушение сна и постоянные сеансы связи быстро накапливали усталость. Позднейшие оценки её самочувствия противоречат друг другу, поэтому важнее проверяемый результат: программа продолжалась почти трое суток, а корабль и космонавт сохранили работоспособность до возвращения.',
                'Перед посадкой автоматика развернула корабль и выдала тормозной импульс. На высоте около шести с половиной километров Терешкова катапультировалась и спустилась отдельно от капсулы в Казахстане. «Чайка» стала первой женщиной, самостоятельно выполнившей космический полёт; следующая женщина, Светлана Савицкая, отправилась на орбиту только через девятнадцать лет.'
            ],
            ...
            ], 'spacecraft/vostok-3ka.png', 'Реалистичная учебная иллюстрация корабля Восток 3КА, использованного в миссии Восток-6'),
            trajectory: earthOrbitTrajectory('1963-06-16T09:29:52Z', '1963-06-19T08:20:00Z', {
                ...
                phaseDeg: -60, displayOrbits: 4, launchAngleDeg: -60, launchProgress: 0.035,
                launchSite: 'Космодром Байконур', returnMode: 'landing'
            }),
            targets: [target('earth', 'Земля', 'earth', 'primary')],
            events: [
        ...
        mission({
            ...
            result: 'Подтверждена возможность выхода человека из корабля и работы автономного скафандра в вакууме.',
            story: [
            ...
            simulationStory: [
                'Корабль «Восход» нельзя было полностью разгерметизировать: его электроника охлаждалась воздухом кабины и могла перегреться. Поэтому для выхода в космос за девять месяцев создали надувной шлюз «Волга». В сложенном виде он лежал у люка, а на орбите развернулся в цилиндр длиной около двух с половиной метров, позволив Беляеву остаться внутри герметичного корабля.',
                'Форма шлюза удерживалась примерно сорока надувными силовыми элементами, объединёнными в независимые группы. Четыре сферических баллона хранили кислород для развёртывания и наполнения камеры. Внутри работали два светильника, а исторический выход снимали три 16-миллиметровые камеры — две в шлюзе и одна снаружи на специальной штанге.',
                'Алексей Леонов вышел через наружный люк и удалился на длину 5,35-метрового фала. За 12 минут 9 секунд вне корабля он несколько раз отходил и возвращался к шлюзу, наблюдая огромный участок Земли. Но вакуум сделал скафандр жёстким: перчатки и обувь сместились, суставы почти перестали сгибаться, и космонавт не мог протиснуться обратно обычным способом.',
                'Леонов снизил давление в скафандре и, вопреки инструкции, вошёл в шлюз головой вперёд, после чего с трудом развернулся в тесной камере. Опасности не закончились: экипаж столкнулся с проблемами герметизации люка, а автоматическая система посадки отказала. Павлу Беляеву пришлось вручную ориентировать корабль и включать тормозной двигатель.',
                'Перед входом в атмосферу приборный отсек отделился не сразу, и связка модулей начала вращаться, пока соединения не разрушились на высоте около ста километров. Из-за задержки ручного торможения корабль сел примерно в 386 километрах от расчётной зоны — в заснеженном лесу. Спасатели добрались до экипажа не сразу, но Беляев и Леонов выжили, завершив один из самых рискованных ранних полётов.'
            ],
            ...
            ], 'spacecraft/voskhod-2.png', 'Реалистичная учебная иллюстрация корабля Восход-2 с развёрнутым шлюзом Волга'),
            trajectory: earthOrbitTrajectory('1965-03-18T07:00:00Z', '1965-03-19T09:02:17Z', {
                ...
                phaseDeg: -60, displayOrbits: 2, launchAngleDeg: -60, launchProgress: 0.06,
                launchSite: 'Космодром Байконур', returnMode: 'landing'
            }),
            targets: [target('earth', 'Земля', 'earth', 'primary')],
            events: [
            ...
            sources: [
                source('nasa-spacewalk-history', 'Spacewalking History', 'NASA', 'https://www.nasa.gov/history/space-station-20th-spacewalking-history/'),
                source('nasa-voskhod-2-report', 'Spaceflight Mission Report: Voskhod 2', 'NASA', 'https://sma.nasa.gov/SignificantIncidents/assets/spaceflight-mission-report_-voskhod-2.pdf')
            ]
        }),
